...
export default function LoginForm() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            try {
                ...
                dispatch(action);
                // Điều hướng tới trang thông tin sau khi đăng nhập
    ...
    console.log('popup_type_loginform', popup_type);
                    ...
                    <div className="modal-content">
                        <div className="modal-header bg-color">
                            ...
                            <div className="text-center">
                                ...
                                {/* Facebook login */}
                                <Link className="btn btn-primary facebook-login" href="#"><i className="fab fa-facebook-f" /> Đăng nhập bằng Facebook</Link>
                            </div>
                        </div>
