...
export default function Cart() {
    ...
    console.log('popup_type_registerform', popup_type);
                        ...
                        <div className="modal-footer">
                            <div className="clearfix">
                                <div className="col-xs-12 text-right">
                                    ...
                                    <Link to="" onClick={(e) => handleContinueShop(e)} name="back-shopping" className="btn btn-default" >Tiếp tục mua sắm</Link>
                                    <Link to="" onClick={(e) => handleOrder(e)} name="checkout" className="btn btn-primary" >Đặt hàng </Link>
                                </div>
                            </div>
                        </div>
                    </div>
