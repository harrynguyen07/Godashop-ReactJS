...
import { axiosNonAuthInstance, formatMoney } from '../helper/ultil';
...
export default function ProductInner({ product }) {
    ...
    const handleAddProductCartInner = async (id, e) => {
            ...
            <div className="row product-info">
                ...
                <div className="col-md-6">
                    ...
                    <div className="product-item-price">
                        <span>Giá: </span>
                        {
                            product.price !== product.sale_price ?
                                <span className="product-item-regular">{formatMoney(product.price)}₫</span> : null
                        }
                    ...
                    <div className="input-group">
                        ...
                        <Link to="#" onClick={(e) => handleAddProductCartInner(product.id, e)} className="buy-in-detail btn btn-success cart-add-button"><i className="fa fa-shopping-cart" /> Thêm vào giỏ hàng</Link>
                    </div>
