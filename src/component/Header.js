...
export default function Header() {
    ...
    // đăng ký với store về thay đổi trạng thái đăng nhập, đăng xuất
                                    ...
                                    <li className="account-login">
                                        {
                                            isLogin ?
                                                ...
                                                :
                                                <Link to="#" onClick={() => handlePopupRegister()} className="btn-register">Đăng Ký</Link>
                                        }
                                    ...
                                    <li>
                                        {
                                            isLogin ?
                                                ...
                                                :
                                                <Link to="#" onClick={() => handlePopupLogin()} className="btn-login">Đăng Nhập</Link>
                                        }
                ...
                <nav className="navbar navbar-default desktop-menu">
                    <div className="container">
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            <li className="cart"><Link onClick={() => handlePopupCart()} to="#" className="btn-cart-detail" title="Giỏ Hàng"><i className="fa fa-shopping-cart" /> <span className="number-total-product">{totalItem}</span></Link></li>
                        </ul>
                    </div>
                </nav>
            </div>
